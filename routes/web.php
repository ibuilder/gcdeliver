...
Route::resource('projects', ProjectController::class)->except(['create','store', 'index', 'show', 'edit', 'update']);
...
Route::resource('deliveries', DeliveryController::class)->except(['create','store', 'index', 'show', 'edit', 'update']);
